...
3. Extraia todo o conteúdo para uma pasta de caminho curto, como `C:\VFL2`.
...
- aproximadamente 1,2 GB livres após a extração;
- não requer instalação de Python, FFmpeg ou do modelo de IA;
- a separação por IA funciona pelo processador, inclusive em computadores com RTX 3060 ou sem GPU NVIDIA.
